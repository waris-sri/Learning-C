...
void area_cal(char opt, float n1, float n2, float n3) {
  ...
  case 'S':
    scanf("%f", &n1);
    printf("Hi! The area of Square is equal to %.2f.", n1 * n1);
    break;
  case 'R':
    scanf("%f %f", &n1, &n2);
  ...
  case 'C':
    scanf("%f", &n1);
    printf("Hi! The area of Circle is equal to %.2f.", PI * n1 * n1);
    break;
  case 'T':
    scanf("%f %f", &n1, &n2);
    printf("Hi! The area of Triangle is equal to %.2f.", 0.5f * n1 * n2);
    break;
  case 'Z':
